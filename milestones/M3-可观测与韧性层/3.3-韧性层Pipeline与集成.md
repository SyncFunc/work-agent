...
```python
class Pipeline:
    def __init__(self, *, rate_limiter=None, circuit_breaker=None, fallback=None, name="", rate_limit_key="default"): ...
...
```python
def build_pipeline(*, name, rate_limiter, circuit_breaker, fallback, rate_limit_key="default") -> Pipeline | None:
